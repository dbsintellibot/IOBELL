-- Migration: Update get_device_config to include device volume config
-- Description: Fetches the device's volume level from bell_devices and returns it in the config JSON.
