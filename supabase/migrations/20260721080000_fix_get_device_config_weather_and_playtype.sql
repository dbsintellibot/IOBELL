-- Migration: Fix get_device_config play_type merging and include_weather support
-- Description: Ensures play_type isn't merged with MAX(CASE) causing MP3s to drop, and adds include_weather (iw) to returned JSON schedule.
