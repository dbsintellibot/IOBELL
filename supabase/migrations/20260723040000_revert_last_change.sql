-- Migration: Revert last change and restore get_device_config
-- Target Project: hjlwzkwiweocnfztshmy
-- Description: Restores get_device_config RPC function and pre-combining behavior to state prior to prompt.
