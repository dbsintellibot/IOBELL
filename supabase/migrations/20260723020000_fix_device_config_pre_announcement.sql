-- Migration: Fix pre_announcement parameters in get_device_config
-- Target Project: hjlwzkwiweocnfztshmy
-- Description: Ensures get_device_config returns valid pre_announcement_enabled and pre_announcement_url 
--              settings from the school table instead of hardcoded false/empty values, so fallbacks play chime correctly.
