ALTER TABLE public.bell_devices ADD COLUMN IF NOT EXISTS location_continent text;

DROP FUNCTION IF EXISTS public.update_device_location(uuid, text, text);
DROP FUNCTION IF EXISTS public.update_device_location(uuid, text, text, text);
DROP FUNCTION IF EXISTS public.update_device_location(uuid, text, text, text, text);
...
BEGIN
  ...
  SET
    ...
    location_continent = p_location_continent,
